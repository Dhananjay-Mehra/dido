  ...
  return (
    <footer className="w-full text-[#111] bg-[#FFFCE1] rounded-tl-[50px] mt-10">
      <div className="grid grid-cols-12 p-8 gap-6">
        ...
        <div className="col-span-12 md:col-span-4 flex flex-col items-left ">
        ...
        <div className="col-span-12 md:col-span-5">
          <h2 className="text-2xl font-bold mb-4">DIDO</h2>
          <p className="text-sm">
            &copy; 2025 DiDo. All Rights Reserved.
          </p>
        ...
        <div className="col-span-12 md:col-span-3 flex justify-end gap-4">
            ...
            <svg className="cursor-pointer" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
